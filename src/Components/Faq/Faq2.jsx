      ...
      <div className={style.faq}>
        ...
        >
          <div>
            <h1 style={f4 === true ? { color: "#412a4c" } : null}>
              Does Toggl Track track GPS and take screenshots?
            </h1>
          ...
          <p style={f4 === false ? { display: "none" } : null}>
            Toggl Track stands against employee surveillance and
            micromanagement. Monitoring has never been a feature in our software
            nor our culture—and it never will be.
            <br />
            Toggl Track is not for managers who are trying to snoop. We will
            never have features for screen recording, location tracking,
            keystroke tracking, or webcam monitoring. We don't spy on our
            employees here at Toggl Track, and we think you shouldn't either.
            <br />
            Read more about why we don't believe in surveillance here.
          </p>
        </div>
        <div
          onClick={() => {
        ...
        >
          ...
          <p style={f5 === false ? { display: "none" } : null}>
            ...
            tools like Asana, Todoist, Trello, and more. The browser extensions
