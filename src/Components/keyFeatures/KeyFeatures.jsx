...
export const KeyFeatures = () => {
  ...
  return (
    <div>
      <div className={style.main_h1_div}>
      ...
      <div className={style.mini_nav}>
        <div>
          <span onClick={handleScroll1}>Time Tracking</span>
        </div>
        <div>
          <span onClick={handleScroll2} className={style.mini_nav_span}>
            Reporting
          </span>
        </div>
        <div>
          <span onClick={handleScroll3} className={style.mini_nav_span}>
            Project & Revenue Tracking
          </span>
        </div>
        <div>
          <span onClick={handleScroll4} className={style.mini_nav_span}>
            Team Scheduling & Management
          </span>
        </div>
      </div>
      <div ref={ref1} className={style.time_tracking}>
        <div>
          <h1 className={style.h1}>Time Tracking</h1>
          <p className={style.p}>There's more than one way to track time</p>
        </div>
      ...
      <div className={style.over_app}>
        <div className={style.over_app_2}>
          <div className={style.over_app_3}>
            <div className={style.over_app_4}>
              <div className={style.over_app_5}>
                <div className={style.over_app_5_1}>
                  <h1>
                    Over 100+ App <br />
                    Integrations
                  </h1>
                  ...
                  <p>
                    ...
                    <span className={style.pink_span}>Chrome</span> and{" "}
                    <span className={style.pink_span}>Firefox</span>.
                  </p>
                  <button className={style.over_app_btn}>
                    See all integrations
                  </button>
                </div>
                <div className={style.over_app_5_2}>
                  <div className={style.over_app_5_2_1}>
                    <img
      ...
      <div ref={ref2} className={style.time_tracking}>
        <div>
          <h1 className={style.h1}>Reporting</h1>
          <p className={style.p}>
        ...
        <h4 className={style.reporting_h4}>
          LOOKING FOR A SPECIFIC USE CASE RELATED TO TIME REPORTING?
        </h4>
        <div className={style.specific_div}>
      ...
      <div className={style.users_love_us}>
        <div>
          <h1
            style={{
              color: "#e57cd8",
        ...
        <button className={style.users_btn}>Try Toggl Track for free</button>
      </div>
      <div ref={ref3} className={style.time_tracking}>
        <div>
          <h1 className={style.h1}>Project & Revenue Tracking</h1>
          <p className={style.p}>Where planning and profits meet</p>
        </div>
        <div className={style.feature_cards}>
          <div>
            {cards5.map((e) => {
      ...
      <div className={style.specific_main_div}>
        <h4 className={style.reporting_h4}>
      ...
      <div ref={ref4} className={style.time_tracking}>
        <div>
          <h1 className={style.h1}>Team Scheduling & Management</h1>
          <p className={style.p}>Where planning and profits meet</p>
        </div>
        <div className={style.feature_cards}>
          <div>
      ...
      <div className={style.on_off_div}>
        <h1 className={style.on_off_h1}>
        ...
        <img
          ...
          style={{ marginBottom: "80px", width: "85%", marginLeft: "100px" }}
          alt=""
        />
      </div>
